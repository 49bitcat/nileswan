...
The parameter is the number of words to read; the following word is the offset in words.

The response is the bytes read.

### 0x13 - EEPROM: Write data

The parameter is the number of words to write; the following word is the offset in words, then the words to write.
