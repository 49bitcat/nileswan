...
void accel_init(void) {
    ...
    NVIC_SetPriority(DMA1_Ch4_7_DMA2_Ch1_5_DMAMUX_OVR_IRQn, MCU_IRQ_PRIORITY_I2C_DMA);
    NVIC_EnableIRQ(DMA1_Ch4_7_DMA2_Ch1_5_DMAMUX_OVR_IRQn);

    NVIC_SetPriority(I2C1_IRQn, MCU_IRQ_PRIORITY_I2C);
    ...
    NVIC_SetPriority(TIM6_DAC_LPTIM1_IRQn, MCU_IRQ_PRIORITY_I2C_TIMER);
