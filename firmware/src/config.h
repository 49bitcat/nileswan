...
#define MCU_IRQ_PRIORITY(n) (n)
#define MCU_IRQ_PRIORITY_PVD MCU_IRQ_PRIORITY(0)
#define MCU_IRQ_PRIORITY_SPI MCU_IRQ_PRIORITY(0)
#define MCU_IRQ_PRIORITY_SPI_DMA MCU_IRQ_PRIORITY(0)
#define MCU_IRQ_PRIORITY_RTC MCU_IRQ_PRIORITY(1)
#define MCU_IRQ_PRIORITY_I2C MCU_IRQ_PRIORITY(2)
#define MCU_IRQ_PRIORITY_I2C_DMA MCU_IRQ_PRIORITY(3)
#define MCU_IRQ_PRIORITY_USB MCU_IRQ_PRIORITY(3)
#define MCU_IRQ_PRIORITY_I2C_TIMER MCU_IRQ_PRIORITY(3)
#define MCU_IRQ_PRIORITY_DEFAULT MCU_IRQ_PRIORITY(3)
